...
class WaterCollectionViewController: UICollectionViewController {
    ...
    private var dataSource:[WaterModel] = [WaterModel]()
    ...
    func initData(){
        ...
        let model = WaterModel(text: "The word “princess” seems to be", imageUrl: "http://a3.qpic.cn/psb?/V12DnVCv4HDP3N/65e5y.cLLIHoLE5sKyVsHbqyAUng4ycFI3aup*tz4Ek!/b/dHIAAAAAAAAA&ek=1&kp=1&pt=0&bo=gALAAwAAAAABAGY!&sce=0-12-12&rf=viewer_311")
            dataSource.append(model)
        let model1 = WaterModel(text: "The word “princess” seems to be a bad word to describe a girl. I saw a real princess in the live show", imageUrl: "http://p0.meituan.net/movie/1f4184f50917f857af37440142f10ee448478.jpg")
        ...
        let model3 = WaterModel(text: "为什么总推荐大家补水，因为现在所有的美白，抗皱，修复！全都是建立在补水的基础上的！我可以负责任的说", imageUrl: "http://a3.qpic.cn/psb?/V10rZR2n2P07ca/tSKf5EXzh38xpTyNLIi.OedzhFQ05r08SiWvSguTpPQ!/b/dHYBAAAAAAAA&ek=1&kp=1&pt=0&bo=gAJUAwAAAAAFB*E!&sce=0-12-12&rf=viewer_4")
